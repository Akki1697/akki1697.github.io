...
let workText = require('https://github.com/STRML/strml.net/blob/b14467731f55f16bf77cc20afdfccdf393e746c5/raw!./work.txt');
let pgpText = require('https://github.com/STRML/strml.net/blob/b14467731f55f16bf77cc20afdfccdf393e746c5/raw!./pgp.txt');
let headerHTML = require('https://github.com/STRML/strml.net/blob/b14467731f55f16bf77cc20afdfccdf393e746c5/raw!./header.html');
let styleText = [0, 1, 2, 3].map(function(i) { return require('raw!./styles' + i + '.css'); });
let preStyles = require('raw%21/prestyles.html');
